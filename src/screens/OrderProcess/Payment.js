      ...
      <View style={{...styles.container}}>
        ...
        <View
          ...
          <View style={{width: width * 0.93}}>
            <Text style={{...styles.PayModeTXT, color: themecolor.TXTWHITE}}>
              Select Payment Method
            </Text>
          </View>
          <View style={{...styles.FLEXR}}>
            <Text style={{...styles.PayModeTXT1, color: themecolor.TXTGREYS}}>
              PAY ONLINE{' '}
            </Text>
            <View
...
<TouchableOpacity activeOpacity={0.5} onPress={() => handleOnline()}>
          ...
          <View style={{...styles.FLEXR, justifyContent: 'space-between'}}>
            <View style={{width: width * 0.8, flexDirection: 'row'}}>
              ...
              />
              <Text style={{...styles.PayModeTXT2, color: themecolor.TXTWHITE}}>
      ...
      <View
        ...
        <View style={{...styles.mainView}}>
          <View
            ...
            <Text style={{...styles.txt1, color: themecolor.TXTWHITE}}>
              <FAIcon name="rupee" size={12} /> 10000
            </Text>
          </View>
